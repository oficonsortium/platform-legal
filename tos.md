...
- **"Contributor"** - a Contributor is an individual or entity that participates in the Collective in some way, such as by acting as a Collective Admin, Financial Contributor, or Expense Submitter, or by participating in any other way, such as attending a Collective’s event.

- **"Collective Admin"** - a Collective Admin is a Contributor that has administrator responsibilities for a Collective, including editing its content and the ability to approve expense payments associated with the Collective. Additional terms for Collective Admins are included in Section 5 below.
...
(b) For clarity, the Platform does not at any time receive, hold, or control funds on behalf of users. All funds, including any Platform Tips (described in Section 9 (Fees)), are collected by Hosts through integrated third-party Payment Processors or through other approved or manual payment methods.
...
(d) "Payment Processor" means a third-party service provider integrated with the Platform that processes Contributions from Financial Contributors and disburses approved Expense payments on behalf of Hosts. Payment Processors may charge their own fees ("Payment Processor Fees") and may include services such as Stripe, PayPal, and Wise.
...
(c) **Recurring Payments.** You may authorize a recurring contribution to a Host for designation to a Collective by indicating as much through the Platform ("**Recurring Contribution**"). For a Recurring Contribution, you are authorizing our designated third-party Payment Processor service to charge the amount specified to your Payment Method on the day that the initial contribution is made and to charge the same amount at the beginning of every calendar month thereafter (or the beginning of every year if the renewal period is annual). For example, if you initiate a recurring payment of $10 on January 25th, you will be charged $10 on that day, and $10 on February 1st and the first day of every calendar month thereafter until you cancel. **When you initiate a recurring contribution to a Host for designation to a Collective, you expressly agree that our third-party Payment Processor service is authorized to charge you on a monthly basis (or on an annual basis, if specified via the platform) for the same payment amount until you cancel it or we suspend or stop providing you access to the platform in accordance with these Terms.**
...
(d) **Host Fees**. You may charge a reasonable fee to the Collective in exchange for providing host services. You must disclose this fee clearly and conspicuously in advance of accepting any Collective Admin’s request that you serve as a Host for a Collective. Host Fees are distinct from Platform Tips and Platform Fees, which support the maintenance and development of the Platform as described in Section 9 (Fees).
